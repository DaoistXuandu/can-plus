...
import StarBorder from "@/app/lib/icon/review";
import { navbar } from "@/app/lib/content/customer/rating";
                ...
                <div className="w-full flex pt-3 md:pt-8 flex-row items-center ">
                    <div className="
                        ...
                        <div className="hidden md:flex">
                            <StarBorder size={90} stroke={1} />
                        </div>
                        <div className="text-center w-full">
                            <h1 className="font-bold text-center md:text-left text-5xl md:text-5xl">{navbar.title}</h1>
                        </div>
                    </div>
                </div>
            </div>
