...
export default function NavBar() {
    ...
    function handleChangeEdit(value: number) {
    ...
    return (
        <div style={{ backgroundColor: "#ECF0F1" }} className="z-20 w-full pb-3">
            <div style={{ backgroundColor: "#ECF0F1" }} className={`fixed z-50 md:z-40 w-full`}>
                <div className="relative flex bg-white  md:bg-transparent shadow-md md:shadow-none p-5 lg:p-10 lg:pb-5 lg:pl-16 lg:pr-16 md:p-10 md:pl-10 md:pr-10 flex-col md:flex-row w-full flex items-center justify-center ">
                    <div className="md:relative w-full md:w-4/12 lg:w-3/12 flex items-center">
                        ...
                        <div className="w-full cursor-pointer flex justify-center md:justify-start" onClick={e => router.push("/pages/merchant/main")}>
            ...
            <div className="relative w-full pb-3">
                    ...
                    <div className="
                        ...
                        <div className="flex flex-col">
                            <div
                                ...
                                <div
                                    onClick={e => router.push("/pages/merchant/main/rating")}
                ...
                <div className="relative z-30 pl-5 pr-5 md:pr-0 md:pl-10 lg:pl-16 mt-2 cursor-pointer select-none w-full lg:w-1/2">
                    <div className="text-black flex flex-row space-x-5">
                        {
                            changeData.map((item, index) => (
                                <ChangeLink name={item} currentEdit={currentEdit} change={handleChangeEdit} dataIndex={index} />
                            ))
                        }
                    </div>
                </div>
