...
export default function Option() {
    ...
    return (
        <div className="w-full flex flex-col md:flex-row md:space-x-4 justify-end">
            ...
            <div
                className={`p-4 md:p-0 flex flex-row ${small ? "hover:bg-gray-200" : ""} md:flex-col items-center space-x-5 border boder-2 border-gray-200 border-r-0 border-l-0 md:border-0`}
